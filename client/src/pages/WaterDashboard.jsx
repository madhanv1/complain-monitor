...
const WaterDashboard = () => {
    ...
    return (
        <div style={styles.wrapper}>
            <Navbar title="Water Usage Management" />
                ...
                <div style={styles.statsGrid}>
                    ...
                    <div style={styles.statCard} className="glass-card hover-lift">
                        ...
                        <div style={styles.statContent}>
                            ...
                            <div style={styles.statValue}>{currentConsumption} L</div>
                        </div>
                    </div>
                </div>
                ...
                <div style={styles.mainGrid}>
                    ...
                    <div style={styles.formCard} className="glass-card">
                        <div style={styles.cardHeader}>
                            ...
                            <p style={styles.cardSubtitle}>Record daily water consumption data</p>
                        </div>
                    ...
                    <div style={styles.historyCard} className="glass-card">
                        <div style={styles.cardHeader}>
                            ...
                            <p style={styles.cardSubtitle}>Recent water usage submissions</p>
                        </div>
                                ...
                                <tbody>
                                    {history.map((item, index) => (
                                        <tr key={item._id} style={{ ...styles.tableRow, animationDelay: `${index * 0.05}s` }} className="animate-slideIn">
                                            ...
                                            <td style={styles.td}>
                                                <span style={styles.consumptionValue}>{item.consumption} L</span>
                                            </td>
                                            <td style={styles.td}>
